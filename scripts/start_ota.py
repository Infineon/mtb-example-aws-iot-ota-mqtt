...
parser.add_argument("--buildlocation", help="build folder location (can be relative)", default="../build/CY8CKIT-064S0S2-4343W/Debug", required=False)
...
class AWS_IoT_OTA:
    ...
    def BuildFirmwareFileNames(self):
        ...
        self.APP_NAME="mtb-example-aws-iot-ota-mqtt_" + args.appversion + ".bin"
        self.APP_FULL_NAME=self.BUILD_PATH / Path(self.APP_NAME)
        self.BUILD_FILE_FULL_NAME=self.BUILD_PATH / Path("mtb-example-aws-iot-ota-mqtt.bin")
